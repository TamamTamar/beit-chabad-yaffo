                ...
                {watchIs12Months && (
                    <>
                        <input
                            type="text"
                            {...register("Zeout", {
                                required: watchIs12Months, // חובה רק ב־HK
                                maxLength: 9,
                                minLength: 9,
                                pattern: {
                                    value: /^[0-9]{9}$/,
                                    message: "נא להזין תעודת זהות בת 9 ספרות"
                                }
                            })}
                            placeholder="תעודת זהות"
                            className="form-input"
                        />
                        {errors.Zeout && <span className="error">{errors.Zeout.message}</span>}

                        
                        {/* נוודא גם טכנית את Tashlumim=1 */}
                        <input type="hidden" {...register("Tashlumim")} value={1} />
                    </>
                )}
